...
const TaskNumber = ({data}) => {
  return (
    <div className='flex mt-10 justify-between gap-5 w-screenscreen'>
      ...
      <div className=' rounded-xl w-[45%] py-6 px-9 bg-emerald-900'>
        <h2 className='text-3xl font-semibold'>{data.taskStats.active}</h2>
        <h3 className='text-xl font-medium'>Accepted Task </h3>
      </div>

      <div className=' rounded-xl w-[45%] py-6 px-9 bg-[#2F3E46]'>
